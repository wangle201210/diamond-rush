...
func TestKnownRolesFromJavaAnchors(t *testing.T) {
	tests := []struct {
		...
		{PlayerLayer, 8, "explosive boulder"},
		{PlayerLayer, 10, "diggable tile"},
		{PlayerLayer, 11, "crawling enemy"},
		{PlayerLayer, 12, "bonus quota marker"},
		{PlayerLayer, 14, "moving hazard"},
		{PlayerLayer, 16, "two-cell spear"},
		{PlayerLayer, 18, "fan switch"},
		...
		{PlayerLayer, 28, "extending spike column"},
		{PlayerLayer, 30, "breakable wall"},
		{PlayerLayer, 31, "keyed lock body"},
		{PlayerLayer, 33, "passable marker raw 33"},
		{PlayerLayer, 34, "blue fan pot"},
		{PlayerLayer, 35, "red fan pot"},
		{PlayerLayer, 36, "crawler trap"},
		{PlayerLayer, 37, "blast wall"},
		{PlayerLayer, 38, "water source"},
		{PlayerLayer, 40, "water-breathing potion"},
		{PlayerLayer, 41, "bonus value pickup"},
		{PlayerLayer, 42, "compass"},
		{PlayerLayer, 51, "artifact pickup raw 51"},
		...
		{ForegroundLayer, 80, "world tile/frame reference"},
